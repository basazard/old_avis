...
<div class="page-content">
    ...
    <div class="main-wrapper">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <button class="btn btn-secondary ml-3" id="eventNear"><i class="fas fa-calendar"></i>
                                Events</button>
                            <a class="btn btn-secondary ml-3" type="button" value="cost" id="costButton"><i class="fas fa-money-check-alt"></i> Cost</a>
                                        ...
                                        <?php if (isset($eventInternal)) : ?>
                                            <?php foreach ($eventInternal as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('project/event/'.$projectrow->id.'/'.$customer->id.'/'.$row->event_name) ?>" type="button" class="badge badge-info" data-toggle="tooltip" data-placement="top" title="View"><span class="material-icons" style="color: white;">visibility</span></a>
                                                        <?php if (user()->level_id == '3' || user()->level_id == '2' || user()->level_id == '1') { ?>
        ...
        <script>
            ...
            if (show === 'quality') {
                jQuery(function(){
                jQuery('#qualityButton').click();
                });
            }
            if (show === 'cost') {
                jQuery(function(){
                jQuery('#costButton').click();
                });
            }
            if (show === 'delivery') {
                jQuery(function(){
                jQuery('#eventNear').click();
                });
            }
        </script>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($child_task as $ct) : ?>
                                    <?php if ($ct->project_id == $projectrow->id) : ?>
                                        ...
                                        <td>
                                            <span data-toggle="modal" data-target="#updateChildTask<?= $ct->cid ?>" ><a type="button" style="color: white;" class="badge badge-info" data-toggle="tooltip" data-placement="top" title="View"><span class="material-icons">visibility</span></a>
                                            </span>
                                            <?php if (user()->level_id == 3 || user()->level_id == 1) : ?>
